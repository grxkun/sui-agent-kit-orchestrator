...
import { NAVI_MAINNET, NAVI_TESTNET } from './constants.js';

function getConfig(network: BuildContext['network']) {
  return network === 'mainnet' ? NAVI_MAINNET : NAVI_TESTNET;
}

export class NaviAdapter implements ProtocolAdapter {
  readonly name = 'navi' as const;
